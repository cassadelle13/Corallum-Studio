...
export const ExecutionLogs: React.FC<ExecutionLogsProps> = ({ isOpen, onToggle }) => {
  ...
  useEffect(() => {
    // Reset collapsed state when opening the panel
    if (isOpen) {
  ...
  return (
    <>
      <div className="execution-logs-overlay" onClick={handleClose} />
      <div 
        className={`execution-logs-panel ${isCollapsed ? 'collapsed' : 'expanded'}`}
      ...
      >
        <div className="logs-header">
          ...
          <div className="logs-actions">
            ...
            <button 
              className="logs-btn logs-close-btn"
              onClick={handleClose}
              title="Close"
            >
              <X size={16} />
